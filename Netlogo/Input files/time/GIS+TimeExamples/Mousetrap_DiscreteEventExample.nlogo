...
to pop
    ...
    set pcolor red   ; Show the snap
     wait 0.02        ; So we can see things happen on the View
...
This NetLogo code implements the version of the Mousetrap model described in Section 14.2.5 of _Agent-Based and Individual-Based Modeling, Second edition_, Railsback & Grimm (2018). This model is completely independent of the Mousetrap model in NetLogo's Models library.
